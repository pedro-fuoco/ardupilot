...
public:
    ...
    void handle_vision_position_estimate(uint64_t remote_time_us, uint32_t time_ms, Vector3f position, const Quaternion &attitude, float posErr, float angErr, uint8_t reset_counter);

...
constexpr struct AP_DDS_Client::Topic_table AP_DDS_Client::topics[] = {
    ...
    {
        .topic_id = to_underlying(TopicIndex::TRANSFORMS_SUB),
        .pub_id = to_underlying(TopicIndex::TRANSFORMS_SUB),
        .sub_id = to_underlying(TopicIndex::TRANSFORMS_SUB),
        .dw_id = uxrObjectId{.id=to_underlying(TopicIndex::TRANSFORMS_SUB), .type=UXR_DATAWRITER_ID},
        .dr_id = uxrObjectId{.id=to_underlying(TopicIndex::TRANSFORMS_SUB), .type=UXR_DATAREADER_ID},
        .topic_profile_label = "tf__t",
        .dw_profile_label = "",
        .dr_profile_label = "tf__dr",
    },
};
